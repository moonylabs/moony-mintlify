...
<div style={{ display: 'flex', flexDirection: 'column', gap: '1rem', marginTop: '1.5rem', marginBottom: '2rem' }}>
  ...
  <div className="principle-card" style={{
    ...
    <div style={{
      ...
      alignItems: 'center',
      gap: '0.5rem'
    }}><Icon icon="users" size={18} color="currentColor" /> Users & Community Members</div>
    <p style={{
      margin: 0,
      lineHeight: '1.6',
      color: '#475569',
  ...
  <div className="principle-card" style={{
    ...
    <div style={{
      ...
      alignItems: 'center',
      gap: '0.5rem'
    }}><Icon icon="store" size={18} color="currentColor" /> Merchants & Service Providers</div>
    <p style={{
      margin: 0,
      lineHeight: '1.6',
      color: '#475569',
  ...
  <div className="principle-card" style={{
    ...
    <div style={{
      ...
      alignItems: 'center',
      gap: '0.5rem'
    }}><Icon icon="plug" size={18} color="currentColor" /> Integrators & Infrastructure Partners</div>
    <p style={{
      margin: 0,
      lineHeight: '1.6',
      color: '#475569',
  ...
  <div className="principle-card" style={{
    ...
    <div style={{
      ...
      alignItems: 'center',
      gap: '0.5rem'
    }}><Icon icon="code" size={18} color="currentColor" /> Developers & Builders</div>
    <p style={{
      margin: 0,
      lineHeight: '1.6',
      color: '#475569',
  ...
  <div className="principle-card" style={{
    ...
    <div style={{
      ...
      alignItems: 'center',
      gap: '0.5rem'
    }}><Icon icon="graduation-cap" size={18} color="currentColor" /> Creators & Educators</div>
    <p style={{
      margin: 0,
      lineHeight: '1.6',
      color: '#475569',
...
<div style={{ display: 'flex', flexDirection: 'column', gap: '1rem', marginTop: '1.5rem', marginBottom: '2rem' }}>
  ...
  <div className="principle-card" style={{
    ...
    <div style={{
      ...
      alignItems: 'center',
      gap: '0.5rem'
    }}><Icon icon="door-open" size={18} color="currentColor" /> Independent Contribution</div>
    <p style={{
      margin: 0,
      lineHeight: '1.6',
      color: '#475569',
  ...
  <div className="principle-card" style={{
    ...
    <div style={{
      ...
      alignItems: 'center',
      gap: '0.5rem'
    }}><Icon icon="layer-group" size={18} color="currentColor" /> Stackable Participation</div>
    <p style={{
      margin: 0,
      lineHeight: '1.6',
      color: '#475569',
  ...
  <div className="principle-card" style={{
    ...
    <div style={{
      ...
      alignItems: 'center',
      gap: '0.5rem'
    }}><Icon icon="arrows-rotate" size={18} color="currentColor" /> Organic Network Effects</div>
    <p style={{
      margin: 0,
      lineHeight: '1.6',
      color: '#475569',
