...
<div style={{ display: 'flex', flexDirection: 'column', gap: '1rem', marginTop: '1.5rem', marginBottom: '2rem' }}>
  ...
  <div className="principle-card" style={{
    ...
    <div style={{
      ...
      alignItems: 'center',
      gap: '0.5rem'
    }}><Icon icon="calendar-days" size={18} color="currentColor" /> Subscriptions</div>
    <p style={{
      margin: 0,
      lineHeight: '1.6',
      color: '#475569',
  ...
  <div className="principle-card" style={{
    ...
    <div style={{
      ...
      alignItems: 'center',
      gap: '0.5rem'
    }}><Icon icon="ban" size={18} color="currentColor" /> Bottlenecks</div>
    <p style={{
      margin: 0,
      lineHeight: '1.6',
      color: '#475569',
  ...
  <div className="principle-card" style={{
    ...
    <div style={{
      ...
      alignItems: 'center',
      gap: '0.5rem'
    }}><Icon icon="building" size={18} color="currentColor" /> Centralization</div>
    <p style={{
      margin: 0,
      lineHeight: '1.6',
      color: '#475569',
...
<div style={{ display: 'flex', flexDirection: 'column', gap: '1rem', marginTop: '1.5rem', marginBottom: '2rem' }}>
  ...
  <div className="principle-card" style={{
    ...
    <div style={{
      ...
      alignItems: 'center',
      gap: '0.5rem'
    }}><Icon icon="coins" size={18} color="currentColor" /> Pay-Per-Use</div>
    <p style={{
      margin: 0,
      lineHeight: '1.6',
      color: '#475569',
  ...
  <div className="principle-card" style={{
    ...
    <div style={{
      ...
      alignItems: 'center',
      gap: '0.5rem'
    }}><Icon icon="cart-shopping" size={18} color="currentColor" /> In-App Purchase</div>
    <p style={{
      margin: 0,
      lineHeight: '1.6',
      color: '#475569',
  ...
  <div className="principle-card" style={{
    ...
    <div style={{
      ...
      alignItems: 'center',
      gap: '0.5rem'
    }}><Icon icon="water" size={18} color="currentColor" /> Streaming Payments</div>
    <p style={{
      margin: 0,
      lineHeight: '1.6',
      color: '#475569',
  ...
  <div className="principle-card" style={{
    ...
    <div style={{
      ...
      alignItems: 'center',
      gap: '0.5rem'
    }}><Icon icon="robot" size={18} color="currentColor" /> M2M Commerce</div>
    <p style={{
      margin: 0,
      lineHeight: '1.6',
      color: '#475569',
  ...
  <div className="principle-card" style={{
    ...
    <div style={{
      ...
      alignItems: 'center',
      gap: '0.5rem'
    }}><Icon icon="heart" size={18} color="currentColor" /> Direct Support</div>
    <p style={{
      margin: 0,
      lineHeight: '1.6',
      color: '#475569',
