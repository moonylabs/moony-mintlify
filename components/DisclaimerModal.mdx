...
export const DisclaimerModal = () => {
  ...
  return (
    ...
    >
      ...
      >
        <h2 style={{ marginTop: 0, marginBottom: '1.5rem', color: '#1e293b', fontSize: '1.5rem', fontWeight: 600 }}>
          Before Proceeding, Please Review
        </h2>
        
        <div style={{ marginBottom: '1.5rem' }}>
          <h3 style={{ marginTop: 0, marginBottom: '0.75rem', color: '#502792', fontSize: '1.125rem', fontWeight: 600 }}>
            Informational Use Only
          </h3>
          <p style={{ marginBottom: '1rem', color: '#475569', lineHeight: '1.6', textAlign: 'justify' }}>
        ...
        <div style={{ marginBottom: '1.5rem' }}>
          ...
          <p style={{ marginBottom: 0, color: '#475569', lineHeight: '1.6', textAlign: 'justify', fontWeight: 500 }}>
